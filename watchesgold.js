...
function myFunction() {
  status = "unsort";
  let requestURL = 'Watches_Gold.json';
  ...
  function dataReportStatus(data) {
    ...
    for (var i = 0; i < (data.watches.length / 4) - 1; i++) {
      ...
      for (var j = countpic; j < countpic + 4; j++) {
        ...
        for (var k = 0; k < findpum; k++) {
          ...
          if (test == 0) {
            if (button.getAttribute("value") == "Rose Gold") {
              ...
              if (data.watches[j].statusrg == "สินค้าหมด") {
            ...
            if (button.getAttribute("value") == "Silver") {
              ...
              if (data.watches[j].statussv == "สินค้าหมด") {
                boxstatus.style.backgroundColor = "rgb(244, 244, 244)";
                boxstatus.style.color = "rgb(110, 110, 110)";
                boxstatus.innerHTML = "สินค้าหมด";
                boxstatus.style.fontSize = "80%";
            ...
            if (button.getAttribute("value") == "Gold") {
              ...
              if (data.watches[j].statusgo == "สินค้าหมด") {
                boxstatus.style.backgroundColor = "rgb(244, 244, 244)";
                boxstatus.style.color = "rgb(110, 110, 110)";
                boxstatus.innerHTML = "สินค้าหมด";
                boxstatus.style.fontSize = "80%";
        ...
        p3.innerHTML = "จาก ฿" + data.watches[j].price[0] + " บาท";
...
function changecolor(obj,event) {
  ...
  function dataReportStatus(data) {
    ...
    if (value1 == "Silver") {
      if (data.watches[id - 1].statussv == "สินค้าหมด") {
    ...
    if (value1 == "Rose Gold") {
      if (data.watches[id - 1].statusrg == "สินค้าหมด") {
        box_status.style.visibility = "visible";
        box_status.style.backgroundColor = "rgb(244, 244, 244)";
        box_status.style.color = "rgb(110, 110, 110)";
        box_status.innerHTML = "สินค้าหมด";
    ...
    if (value1 == "Gold") {
      if (data.watches[id - 1].statusgo == "สินค้าหมด") {
        box_status.style.visibility = "visible";
        box_status.style.backgroundColor = "rgb(244, 244, 244)";
        box_status.style.color = "rgb(110, 110, 110)";
        box_status.innerHTML = "สินค้าหมด";
...
function over1() {
  var boxunderb1 = document.getElementById("boxunderb1")
  var imgunder1 = document.getElementById("imgunder1")
  
  boxunderb1.style.backgroundColor = "black";
  imgunder1.style.opacity = "0.9";
  imgunder1.style.transition = "0.3s";
...
function overout1() {
  ...
  boxunderb1.style.backgroundColor = "none";
  imgunder1.style.opacity = "1";
...
function over4() {
  var boxunderb4 = document.getElementById("boxunderb4")
  var imgunder4 = document.getElementById("imgunder4")

  boxunderb4.style.backgroundColor = "black";
  imgunder4.style.opacity = "0.9";
  imgunder4.style.transition = "0.3s";
...
function overout4() {
  ...
  boxunderb4.style.backgroundColor = "none";
  imgunder4.style.opacity = "1";
...
function over2() {
  var boxunderb2 = document.getElementById("boxunderb2")
  var imgunder2 = document.getElementById("imgunder2")

  boxunderb2.style.backgroundColor = "black";
  imgunder2.style.opacity = "0.9";
  imgunder2.style.transition = "0.3s";
...
function overout2() {
  ...
  boxunderb2.style.backgroundColor = "none";
  imgunder2.style.opacity = "1";
...
function over3() {
  var boxunderb3 = document.getElementById("boxunderb3")
  var imgunder3 = document.getElementById("imgunder3")

  boxunderb3.style.backgroundColor = "black";
  imgunder3.style.opacity = "0.9";
  imgunder3.style.transition = "0.3s";
...
function overout3() {
  ...
  boxunderb3.style.backgroundColor = "none";
  imgunder3.style.opacity = "1";
...
function push(obj) {
  ...
  function dataReportStatus(data) {
    if (status == "unsort") {
      ...
      location.href = "detialwatchgold.html";
    }
