...
var count = 0;
  function dataReportStatus(data) {
    ...
    for(var i=0; i < (data.petite.length / 4 - 1); i++){
        ...
        for(var j=countpic; j<countpic+4; j++){
            ...
            if (data.petite[j].pic_rg[0] == " " && data.petite[j].pic_go[0] == " ") {
              pic.src = data.petite[j].pic_sv[0];
    
            }
            else if (data.petite[j].pic_sv[0] != " " && data.petite[j].pic_go[0] != " " && data.petite[j].pic_rg[0] != " ") {
              pic.src = data.petite[j].pic_rg[0];
    
    
            }
    
    
            else if (data.petite[j].pic_rg[0] == " " && data.petite[j].pic_sv[0] == " ") {
              pic.src = data.petite[j].pic_go[0];
    
    
            }
            else if (data.petite[j].pic_go[0] == " " && data.petite[j].pic_sv[0] == " ") {
              pic.src = data.petite[j].pic_rg[0];
            }
            else if (data.petite[j].pic_go[0] == " ") {
              pic.src = data.petite[j].pic_rg[0];
    
    
            }
            else if (data.petite[j].pic_sv[0] == " ") {
              pic.src = data.petite[j].pic_rg[0];
    
    
            }
            if(data.petite[j].type == "Strap"){
            ...
            if(data.petite[j].status == "สินค้าหมด"){
            ...
            boxname.innerHTML = data.petite[j].name;
            ...
            var findpum = data.petite[j].color.length;
            for (var k = 0; k < findpum; k++) {
              ...
              button.setAttribute("value", data.petite[j].color[k])


              button.style.backgroundColor = data.petite[j].hexcolor[k];
              button.style.marginTop = "0px";
              rowname.appendChild(button);
            }

            var p1 = document.createElement("p");
            p1.innerHTML = data.petite[j].color[0];
          ...
          //   rowcolor2.appendChild(boxcolor);
            ...
            boxprice.innerHTML = "จาก ฿"+data.petite[j].price+" บาท";
    ...
    for (var h = 0; h < 1; h++) {
      ...
      function changecolor(obj) {
        ...
        function dataReportStatus(data) {
          ...
          console.log(data.petite[id - 1].no)
          if (value1 == "Silver") {
            if (data.petite[id - 1].statussv == "สินค้าหมด") {
            ...
            if (data.petite[id - 1].statussv == " ") {
              box_status.style.visibility = "hidden";
      
            }
            if (data.petite[id - 1].pic_sv[0] == " ") {
              changepic.src = data.petite[id - 1].pic_sv[1];
              ...
              changepic.src = data.petite[id - 1].pic_sv[0];
              changenamecolor.innerHTML = value1;
            }
          }
      
          if (value1 == "Rose Gold") {
            if (data.petite[id - 1].statusrg == "สินค้าหมด") {
              box_status.style.visibility = "visible";
              box_status.style.backgroundColor = "rgb(244, 244, 244)";
              box_status.style.color = "rgb(110, 110, 110)";
              box_status.innerHTML = "สินค้าหมด";
            ...
            if (data.petite[id - 1].statusrg == " ") {
              box_status.style.visibility = "hidden";
      
            }
      
            if (data.petite[id - 1].pic_rg[0] == " " || data.petite[id - 1].pic_sv[0] == " ") {
              if (data.petite[id - 1].no == "22") {
                changepic.src = data.petite[id - 1].pic_rg[1];
                changenamecolor.innerHTML = value1;
              }
              else if (data.petite[id - 1].no == "40") {
                changepic.src = data.petite[id - 1].pic_rg[1];
                changenamecolor.innerHTML = value1;
              }
              else if (data.petite[id - 1].no == "42") {
                changepic.src = data.petite[id - 1].pic_rg[1];
                changenamecolor.innerHTML = value1;
              }
              else if (data.petite[id - 1].no == "46") {
                changepic.src = data.petite[id - 1].pic_rg[1];
                changenamecolor.innerHTML = value1;
              }
              else if (data.petite[id - 1].no == "47") {
                changepic.src = data.petite[id - 1].pic_rg[1];
                changenamecolor.innerHTML = value1;
              }
              else if (data.petite[id - 1].no == "49") {
                changepic.src = data.petite[id - 1].pic_rg[1];
                changenamecolor.innerHTML = value1;
              }
              else if (data.petite[id - 1].no == "50") {
                changepic.src = data.petite[id - 1].pic_rg[1];
                changenamecolor.innerHTML = value1;
              }
              else {
                changepic.src = data.petite[id - 1].pic_rg[0];
                changenamecolor.innerHTML = value1;
              }
          ...
          if (value1 == "Gold") {
            if (data.petite[id - 1].statusgo == "สินค้าหมด") {
              box_status.style.visibility = "visible";
              box_status.style.backgroundColor = "rgb(244, 244, 244)";
              box_status.style.color = "rgb(110, 110, 110)";
              box_status.innerHTML = "สินค้าหมด";
            ...
            if (data.petite[id - 1].statusgo == " ") {
              box_status.style.visibility = "hidden";
      
            }
            if (data.petite[id - 1].pic_go[0] == " ") {
              changepic.src = data.petite[id - 1].pic_go[0];
              changenamecolor.innerHTML = value1;
            }
            else {
