...
function myFunction() {
  let requestURL = 'petite_strap_json.json';
  ...
  function dataReportStatus(data) {
    ...
    for (var i = 0; i < (data.Petite_Straps.length / 4) - 1; i++) {
      ...
      for (var j = countpic; j < countpic + 4; j++) {
        ...
        if(data.Petite_Straps[j].No == 5){
          img.src = data.Petite_Straps[j].pic_rg[1];

        }
        else if (data.Petite_Straps[j].pic_rg[0] == " " && data.Petite_Straps[j].pic_go[0] == " ") {
          img.src = data.Petite_Straps[j].pic_sv[0];

        }
        else if (data.Petite_Straps[j].pic_sv[0] != " " && data.Petite_Straps[j].pic_go[0] != " " && data.Petite_Straps[j].pic_rg[0] != " ") {

          
          img.src = data.Petite_Straps[j].pic_rg[0];


        }
        
        else if (data.Petite_Straps[j].pic_rg[0] == " " && data.Petite_Straps[j].pic_sv[0] == " ") {
          img.src = data.Petite_Straps[j].pic_go[0];
        ...
        else if (data.Petite_Straps[j].pic_go[0] == " ") {
          img.src = data.Petite_Straps[j].pic_rg[0];


        }
        else if (data.Petite_Straps[j].pic_sv[0] == " ") {
          img.src = data.Petite_Straps[j].pic_rg[0];
        ...
        p.innerHTML = data.Petite_Straps[j].name;
        ...
        let test = 0;
        var findpum = data.Petite_Straps[j].color.length;
        if(data.Petite_Straps[j].no == "30"){
        ...
        for (var k = 0; k < findpum; k++) {
          ...
          button.setAttribute("value", data.Petite_Straps[j].color[k])


          button.style.backgroundColor = data.Petite_Straps[j].code_color[k];
          box2.appendChild(button);
          //check new item
          if (test == 0) {
            if (button.getAttribute("value") == "Rose Gold") {
              if (data.Petite_Straps[j].statusrg == "NEW") {
                boxstatus.style.backgroundColor = "rgb(205, 188, 122)";
                boxstatus.style.color = "white";
                boxstatus.innerHTML = "NEW";
                test++;
              }
              if (data.Petite_Straps[j].statusrg == "สินค้าหมด") {
            ...
            if (button.getAttribute("value") == "Silver") {
              if (data.Petite_Straps[j].statussv == "NEW") {
                boxstatus.style.backgroundColor = "rgb(205, 188, 122)";
                boxstatus.innerHTML = "NEW";
                boxstatus.style.color = "white";
                test++;
              }
              if (data.Petite_Straps[j].statussv == "สินค้าหมด") {
                boxstatus.style.backgroundColor = "rgb(244, 244, 244)";
                boxstatus.style.color = "rgb(110, 110, 110)";
                boxstatus.innerHTML = "สินค้าหมด";
                boxstatus.style.fontSize = "80%";
            ...
            if (button.getAttribute("value") == "Gold") {
              if (data.Petite_Straps[j].statusgo == "NEW") {
                boxstatus.style.backgroundColor = "rgb(205, 188, 122)";
                boxstatus.innerHTML = "NEW";
                boxstatus.style.color = "white";
                test++;
              }
              if (data.Petite_Straps[j].statusgo == "สินค้าหมด") {
                boxstatus.style.backgroundColor = "rgb(244, 244, 244)";
                boxstatus.style.color = "rgb(110, 110, 110)";
                boxstatus.innerHTML = "สินค้าหมด";
                boxstatus.style.fontSize = "80%";
        ...
        p1.innerHTML = data.Petite_Straps[j].color[0];
        ...
        p3.innerHTML = "จาก ฿" + data.Petite_Straps[j].price[0] + " บาท";
    ...
    for(var h = 0; h < 1; h++){
      ...
      var find = (data.Petite_Straps.length % 4);
      if(find == 0){
        find = 4;  
      }
      for (var j = countpic; j < countpic + find ; j++) {
        ...
        var img = document.createElement("img");
        if (data.Petite_Straps[j].pic_rg[0] == " " && data.Petite_Straps[j].pic_go[0] == " ") {
          img.src = data.Petite_Straps[j].pic_sv[0];
        ...
        else if (data.Petite_Straps[j].pic_go[0] == " " && data.Petite_Straps[j].pic_sv[0] == " ") {
        ...
        rowstatus.appendChild(boxstatus);
        let test = 0;
        for (var k = 0; k < data.Petite_Straps[j].color.length; k++) {
...
function changecolor(obj,event) {
  ...
  function dataReportStatus(data) {
    ...
    console.log(data.Petite_Straps[id-1].no)   
    if (value1 == "Silver") {
      if (data.Petite_Straps[id - 1].statussv == "สินค้าหมด") {
      ...
      if (data.Petite_Straps[id - 1].statussv == " ") {
        box_status.style.visibility = "hidden";

      }
      if (data.Petite_Straps[id - 1].pic_sv[0] == " ") {
        changepic.src = data.Petite_Straps[id - 1].pic_sv[1];
        ...
        changepic.src = data.Petite_Straps[id - 1].pic_sv[0];
        changenamecolor.innerHTML = value1;
      }
    }
    ...
    if (value1 == "Rose Gold") {
      ...
      if (data.Petite_Straps[id - 1].statusrg == "สินค้าหมด") {
        box_status.style.visibility = "visible";
        box_status.style.backgroundColor = "rgb(244, 244, 244)";
        box_status.style.color = "rgb(110, 110, 110)";
        box_status.innerHTML = "สินค้าหมด";
      ...
      if (data.Petite_Straps[id - 1].statusrg == " ") {
        box_status.style.visibility = "hidden";

      }
      if(data.Petite_Straps[id - 1].No == 5){
        changepic.src = data.Petite_Straps[id - 1].pic_rg[1];
        changenamecolor.innerHTML = value1;
      }

      else if (data.Petite_Straps[id - 1].pic_rg[0] == " " || data.Petite_Straps[id - 1].pic_sv[0] == " ") {
        
        changepic.src = data.Petite_Straps[id - 1].pic_rg[0];
        changenamecolor.innerHTML = value1;
    ...
    if (value1 == "Gold") {
      if (data.Petite_Straps[id - 1].statusgo == "สินค้าหมด") {
        box_status.style.visibility = "visible";
        box_status.style.backgroundColor = "rgb(244, 244, 244)";
        box_status.style.color = "rgb(110, 110, 110)";
        box_status.innerHTML = "สินค้าหมด";
      ...
      if (data.Petite_Straps[id - 1].statusgo == " ") {
        box_status.style.visibility = "hidden";

      }
      if(data.Petite_Straps[id - 1].No == 5){
        changepic.src = data.Petite_Straps[id - 1].pic_go[1];
        changenamecolor.innerHTML = value1;
      }
      else if (data.Petite_Straps[id - 1].pic_go[0] == " ") {
        changepic.src = data.Petite_Straps[id - 1].pic_go[0];
        changenamecolor.innerHTML = value1;
      }
      else {
...
function push(obj) {
  ...
  function dataReportStatus(data) {
      ...
      jsarray = data.Petite_Straps[obj];
      sessionStorage.setItem("jsArray", JSON.stringify(jsarray));
      location.href = "detialpetite.html";
    }
  }
