...
function myFunction() {
  status = "unsort";
  let requestURL = 'Watches_man.json';
  ...
  function dataReportStatus(data) {
    ...
    for (var i = 0; i < (data.watches.length / 4) - 1; i++) {
      ...
      for (var j = countpic; j < countpic + 4; j++) {
        ...
        box.setAttribute("onclick", "push(this);")
        ...
        if (data.watches[j].pic_rg[0] == " " && data.watches[j].pic_go[0] == " ") {
         ...
         if (data.watches[j].no == "6") {

            img.src = data.watches[j].pic_rg[1];
          }
          else if (data.watches[j].no == "10") {

            img.src = data.watches[j].pic_rg[1];
          }
          else if (data.watches[j].no == "11") {

            img.src = data.watches[j].pic_rg[1];
          }
          else if (data.watches[j].no == "13") {

            img.src = data.watches[j].pic_rg[1];
          }
          else if (data.watches[j].no == "14") {

            img.src = data.watches[j].pic_rg[1];
          }
          else if (data.watches[j].no == "20") {
