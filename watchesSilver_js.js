...
function myFunction() {
  status = "unsort";
  let requestURL = 'Watches_Silver_json.json';
    ...
    for (var i = 0; i < (data.watches.length / 4) - 1; i++) {
      ...
      for (var j = countpic; j < countpic + 4; j++) {
        ...
        if (data.watches[j].pic_rg[0] == " " && data.watches[j].pic_go[0] == " ") {
          ...
          if (data.watches[j].no == "21") {

            img.src = data.watches[j].pic_rg[1];
          }
          else if (data.watches[j].no == "32") {

            img.src = data.watches[j].pic_rg[1];
          }
          else if (data.watches[j].no == "34") {

            img.src = data.watches[j].pic_rg[1];
          }
          else if (data.watches[j].no == "39") {

            img.src = data.watches[j].pic_rg[1];
          }
          else if (data.watches[j].no == "38") {

            img.src = data.watches[j].pic_rg[1];
          }
          else if (data.watches[j].no == "41") {
  ...
  function dataReportStatus(data) {
    ...
    if (value1 == "Rose Gold") {
      ...
      if (data.watches[id - 1].pic_rg[0] == " " || data.watches[id - 1].pic_sv[0] == " ") {
        if (data.watches[id - 1].no == "21") {
          changepic.src = data.watches[id - 1].pic_rg[1];
          changenamecolor.innerHTML = value1;
        }
        else if (data.watches[id - 1].no == "32") {
          changepic.src = data.watches[id - 1].pic_rg[1];
          changenamecolor.innerHTML = value1;
        }
        else if (data.watches[id - 1].no == "34") {
          changepic.src = data.watches[id - 1].pic_rg[1];
          changenamecolor.innerHTML = value1;
        }
        ...
        else if (data.watches[id - 1].no == "38") {
          changepic.src = data.watches[id - 1].pic_rg[1];
          changenamecolor.innerHTML = value1;
        }
        else if (data.watches[id - 1].no == "41") {
          changepic.src = data.watches[id - 1].pic_rg[1];
          changenamecolor.innerHTML = value1;
        }
      ...
      for (var i = 0; i < (data.watches.length / 4) - 1; i++) {
        ...
        for (var j = countpic; j < countpic + 4; j++) {
          ...
          for (var k = 0; k < findpum; k++) {
            ...
            var button = document.createElement("button")
            button.setAttribute("class", "btn btn-light btn-circle btn-md");
            button.setAttribute("onclick", "changecolor1(this,event);");
      ...
      for (var i = 0; i < (data.watches.length / 4) - 1; i++) {
        ...
        for (var j = countpic; j < countpic + 4; j++) {
          ...
          for (var k = 0; k < findpum; k++) {
            ...
            var button = document.createElement("button")
            button.setAttribute("class", "btn btn-light btn-circle btn-md");
            button.setAttribute("onclick", "changecolor2(this,event);");
      ...
      for (var i = 0; i < (data.watches.length / 4) - 1; i++) {
        ...
        for (var j = countpic; j < countpic + 4; j++) {
          ...
          for (var k = 0; k < findpum; k++) {
            ...
            var button = document.createElement("button")
            button.setAttribute("class", "btn btn-light btn-circle btn-md");
            button.setAttribute("onclick", "changecolor3(this,event);");
...
function changecolor1(obj,event) {
  event.stopPropagation();
  let requestURL = 'Watches_Silver_json.json';
  let request = new XMLHttpRequest();
  request.onreadystatechange = function () {
  ...
  function dataReportStatus(data) {
    ...
    if (value1 == "Rose Gold") {
      ...
      if (data.watches[id - 1].pic_rg[0] == " " || data.watches[id - 1].pic_sv[0] == " ") {
        if (data.watches[id - 1].no == "6") {
          changepic.src = data.watches[id - 1].pic_rg[1];
          changenamecolor.innerHTML = value1;
        }
        else if (data.watches[id - 1].no == "10") {
          changepic.src = data.watches[id - 1].pic_rg[1];
          changenamecolor.innerHTML = value1;
        }
        else if (data.watches[id - 1].no == "11") {
          changepic.src = data.watches[id - 1].pic_rg[1];
          changenamecolor.innerHTML = value1;
        }
        else if (data.watches[id - 1].no == "13") {
          changepic.src = data.watches[id - 1].pic_rg[1];
          changenamecolor.innerHTML = value1;
        }
        else if (data.watches[id - 1].no == "14") {
          changepic.src = data.watches[id - 1].pic_rg[1];
          changenamecolor.innerHTML = value1;
        }
        else if (data.watches[id - 1].no == "20") {
          changepic.src = data.watches[id - 1].pic_rg[1];
          changenamecolor.innerHTML = value1;
        }
...
function changecolor2(obj,event) {
  event.stopPropagation();
  let requestURL = 'Watches_Silver_json.json';
  let request = new XMLHttpRequest();
  request.onreadystatechange = function () {
...
function changecolor3(obj,event) {
  event.stopPropagation();
  let requestURL = 'Watches_Silver_json.json';
  let request = new XMLHttpRequest();
  request.onreadystatechange = function () {
...
function push(obj) {
  ...
  function dataReportStatus(data) {
    if (status == "unsort") {
      ...
      location.href = "detialwatchsilver.html";
    }
