...
function myFunction() {
  ...
  if(data.pic_rg[0] != " "){
    for (let i = -1; i < data.de_pic.depic_rg.length; i++) {
      if (i == -1) {
        ...
        // img.style.marginLeft = "92px"
        if (data.pic_rg[0] != " ") {
          img.src = data.de_pic.depic_rg[i];
        }
  
        else if (data.pic_sv[0] != " ") {
          img.src = data.de_pic.depic_sv[i];
        }
        else if (data.pic_go[0] != " ") {
          img.src = data.de_pic.depic_go[i];
        }
      }
    ...
    for (let i = -1; i < data.de_pic.depic_sv.length; i++) {
      if (i == -1) {
        var img = document.createElement("img")
        boxinupa.appendChild(img)
        img.style.width = "100%"
    ...
    for (let i = -1; i < data.de_pic.depic_go.length+1; i++) {
      if (i == -1) {
        var img = document.createElement("img")
        boxinupa.appendChild(img)
        img.style.width = "100%"
  ...
  else if(data.pic_rgb[0] != " "){
    for (let i = -1; i < data.de_pic.depic_rgb.length; i++) {
      if (i == -1) {
        var img = document.createElement("img")
        boxinupa.appendChild(img)
        img.style.width = "100%"
        ...
        // img.style.marginLeft = "92px"
        if (data.pic_rgb[0] != " ") {
          img.src = data.de_pic.depic_rgb[i];
        }
  ...
  else if(data.pic_rgsw[0] != " "){
    for (let i = -1; i < data.de_pic.depic_rgsw.length; i++) {
      if (i == -1) {
        var img = document.createElement("img")
        boxinupa.appendChild(img)
        img.style.width = "100%"
        ...
        // img.style.marginLeft = "92px"
        if (data.pic_rgsw[0] != " ") {
          img.src = data.de_pic.depic_rgsw[i];
        }
  ...
  else if(data.pic_ssw[0] != " "){
    for (let i = -1; i < data.de_pic.depic_ssw.length; i++) {
      if (i == -1) {
        var img = document.createElement("img")
        boxinupa.appendChild(img)
        img.style.width = "100%"
        ...
        // img.style.marginLeft = "92px"
        if (data.pic_ssw[0] != " ") {
          img.src = data.de_pic.depic_ssw[i];
        }
  ...
  else if(data.pic_rgds[0] != " "){
    for (let i = -1; i < data.de_pic.depic_rgds.length; i++) {
      if (i == -1) {
        var img = document.createElement("img")
        boxinupa.appendChild(img)
        img.style.width = "100%"
        ...
        // img.style.marginLeft = "92px"
        if (data.pic_rgds[0] != " ") {
          img.src = data.de_pic.depic_rgds[i];
        }
  ...
  else if(data.pic_rgdr[0] != " "){
    for (let i = -1; i < data.de_pic.depic_rgdr.length; i++) {
      if (i == -1) {
        var img = document.createElement("img")
        boxinupa.appendChild(img)
        img.style.width = "100%"
        ...
        // img.style.marginLeft = "92px"
        if (data.pic_rgdr[0] != " ") {
          img.src = data.de_pic.depic_rgdr[i];
        }
  ...
  if (data.type == "Ring") {
    label2.style.marginTop = "100px"
    label2.style.marginLeft = "-190px"
  }
  ...
  if (data.type == "Ring") {
    box2in.style.marginTop = "0px"
    box2in.style.marginLeft = "-190px"
  }
  else {
  ...
  for (var s = 0; s < data.size.length; s++) {
    ...
    namesize.innerHTML = data.size[s]
  ...
  if (data.type == "Ring") {
    option.style.marginTop = "-110px"
    option.style.marginLeft = "250px"
  ...
  text2.innerText = data.detail.text2[0]
  divin12.appendChild(text2)
  text2.style.marginTop = "-10px"
  var text21 = document.createElement("label")
  text21.innerText = data.detail.text2[1]
  text21.style.marginLeft = "85%"
  ...
  text3.innerText = data.detail.text3[0]
  divin12.appendChild(text3)
  text3.style.marginTop = "-10px"
  var text31 = document.createElement("label")
  text31.innerText = data.detail.text3[1]
  text31.style.marginLeft = "84%"
  ...
  text4.innerText = data.detail.text4[0]
  divin12.appendChild(text4)
  text4.style.marginTop = "-10px"
  var text41 = document.createElement("label")
  text41.innerText = data.detail.text4[1]
  text41.style.marginLeft = "36%"
  ...
  function dataReportStatus(data1) {
    ...
    if (data.color[0] == "Rose Gold/Desert Sand") {
      let val = data1;
      val = val.filter(x => x.color[0] == "Rose Gold/Desert Sand");
      console.log(val);
      countco = val.length
      if (countco >= 4) {
        countco = 4
      ...
      for (var boxtem = 0; boxtem < countco; boxtem++) {
        ...
        var buttoncolor = document.createElement("button")
        buttoncolor.setAttribute("class", "btn btn-light btn-circle btn-md")
        buttoncolor.style.backgroundImage = "linear-gradient(325deg,  #e6ceb9 50%, #e5ae87 49%)"
        buttoncolor.style.marginTop = "-11px"
        boxboxitem2.appendChild(buttoncolor)
        ...
        pprice.innerText = val[boxtem].price1
        boxboxitem2.appendChild(pprice)
        rowfooterin1.style.marginLeft = "255px"


      }
    }
    if (data.color[0] == "Rose Gold/Black") {
      let val = data1;
      val = val.filter(x => x.color[0] == "Rose Gold/Black");
      console.log(val);
      countco = val.length
      if (countco >= 4) {
        countco = 4
      ...
      for (var boxtem = 0; boxtem < countco; boxtem++) {
        ...
        var buttoncolor = document.createElement("button")
        buttoncolor.setAttribute("class", "btn btn-light btn-circle btn-md")
        buttoncolor.style.backgroundImage = "linear-gradient(325deg,  black 50%, #e5ae87 49%)"
        buttoncolor.style.marginTop = "-11px"
        boxboxitem2.appendChild(buttoncolor)
    ...
    if (data.color[0] == "Rose Gold/Satin White") {
      let val = data1;
      val = val.filter(x => x.color[0] == "Rose Gold/Satin White");
      console.log(val);
      countco = val.length
      if (countco >= 4) {
        countco = 4
      ...
      for (var boxtem = 0; boxtem < countco; boxtem++) {
        ...
        var buttoncolor = document.createElement("button")
        buttoncolor.setAttribute("class", "btn btn-light btn-circle btn-md")
        buttoncolor.style.backgroundImage = "linear-gradient(325deg,  white 50%, #e5ae87 49%)"
        buttoncolor.style.marginTop = "-11px"
        boxboxitem2.appendChild(buttoncolor)
...
function bot_function(data) {
  ...
  function dataReportStatus(data2) {
    ...
    console.log(data);
    let val = data2;
    val = val.filter(x => x.type == data.type);
    console.log(val);
    ...
    for (var k = 0; k < countm; k++) {
      ...
      if (countm == 2) {
        ...
        rowfooterin4.style.marginLeft = "150px"
      }
      else {
      ...
      else if (val[k].color[0] == "Rose Gold/Black") {
        img.src = val[k].pic_rgb[0]
      }
      else if (val[k].color[0] == "Rose Gold/Satin White") {
        img.src = val[k].pic_rgsw[0]
      }
      else if (val[k].color[0] == "Silver/Satin White") {
        img.src = val[k].pic_ssw[0]
      }
      else if (val[k].color[0] == "Rose Gold/Desert Sand") {
        img.src = val[k].pic_rgds[0]
      }
      else if (val[k].color[0] == "Rose Gold/Dusty Rose") {
        img.src = val[k].pic_rgdr[0]
      }
      ...
      // buttoncolor.style.marginTop = "-11px"
      // boxboxitem2.appendChild(buttoncolor)
      var findpum = val[k].color.length;
      
      for (var j = 0; j < findpum; j++) {
        var button = document.createElement("button")
        let test = 0;
        ...
        button.setAttribute("value", val[k].color[j])
        console.log(val[k].code_color[j]);

        if (val[k].code_color[j] == "Rose Gold/Black") {
          button.style.backgroundImage = "linear-gradient(325deg,  black 50%, #e5ae87 49%)"
        }
        else if (val[k].code_color[j] == "Rose Gold/Satin White") {
          button.style.backgroundImage = "linear-gradient(325deg,  white 50%, #e5ae87 49%)"
          button.style.borderColor = "#e5ae87"
        }
        else if (val[k].code_color[j] == "Silver/Satin White") {
          button.style.backgroundImage = "linear-gradient(325deg,  white 50%, #c1c1c1 49%)"
          button.style.borderColor = "#c1c1c1"
        }
        else if (val[k].code_color[j] == "Rose Gold/Dusty Rose") {
          button.style.backgroundImage = "linear-gradient(325deg,  #f7cac9 50%, #e5ae87 49%)"
          button.style.borderColor = "#c1c1c1"
        }

        else if (val[k].code_color[j] == "Rose Gold/Desert Sand") {
          button.style.backgroundImage = "linear-gradient(325deg,  #e6ceb9 50%, #e5ae87 49%)"
          button.style.borderColor = "#c1c1c1"
        }
        else {
          button.style.backgroundColor = val[k].code_color[j];
        }
        boxboxitem2.appendChild(button);
      }
...
function forward(){
  if (data.pic_rg[0] != " ") {
    var max = data.de_pic.depic_rg.length ;
  }

  else if (data.pic_sv[0] != " ") {
    var max = data.de_pic.depic_sv.length ;
  }
  else if (data.pic_go[0] != " ") {
    var max = data.de_pic.depic_go.length ;
  }
  else if (data.pic_rgb[0] != " ") {
    var max = data.de_pic.depic_rgb.length;
  }
  else if (data.pic_rgsw[0] != " ") {
    var max = data.de_pic.depic_rgsw.length;
  }
  else if (data.pic_ssw[0] != " ") {
    var max = data.de_pic.depic_ssw.length;
  }
  else if (data.pic_rgds[0] != " ") {
    var max = data.de_pic.depic_rgds.length;
  }
  else if (data.pic_rgdr[0] != " ") {
    var max = data.de_pic.depic_rgdr.length;
  }
  console.log(max)
  if(picslid == max){
